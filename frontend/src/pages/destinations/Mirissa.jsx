...
export default function MirissaPage() {
  ...
  const destination = {
    ...
    description: 'Mirissa is a small town on the southern coast of Sri Lanka, known for its beautiful beaches, whale watching, and vibrant nightlife. It is a popular destination for travelers seeking relaxation and adventure.',
    image: '/destinations/Mirissa/cover.jpg',
    gallery: [
      '/destinations/Mirissa/beachesM.jpg',
      '/destinations/Mirissa/trainM.jpg',
      '/destinations/Mirissa/whaleM.webp'
    ],
    highlights: [
